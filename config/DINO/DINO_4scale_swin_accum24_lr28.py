# Effective batch 24, lr 2.8e-04 -- arm of the two-point lr bracket above dino_accum24_1.
#
...
# size. dino_accum24_1 scaled only by sqrt(12). This arm is 2x the sqrt-scaled value, i.e. sqrt(12) x 4e-5 doubled -- the midpoint, in log space, between sqrt and linear scaling.
#
# lr = 2.8e-04. Everything else -- grad_accum_steps, warmup_steps, lr_drop, epochs, the SSL
...
#
# RISK: the conservative half of the bracket. The precedent is dino_lrsweep_1 (1.6e-4 at batch 2, NO warmup, NO accumulation),
